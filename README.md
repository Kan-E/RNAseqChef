...
```diff
- RNAseqChef is currently under maintenance. I apologize for the inconvenience.
```
...
```
docker pull omicschef/rnaseqchef:v1.0.7
```
You may now run RNAseqChef with just one command in the command line:
```
docker run --rm -p 3838:3838 omicschef/rnaseqchef:v1.0.7
```
