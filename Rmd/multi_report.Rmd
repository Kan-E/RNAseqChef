---
title: "Multi DEG with RNAseqChef v1.0.6"
...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", echo=FALSE}
if(!is.null(params$multi_kmeans_box) && length(params$input$selectFC2) == 2 && !is.null(params$input$multi_pattern2_count_rows_selected)){
